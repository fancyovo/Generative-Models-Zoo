...
class GAN_Trainer:
    ...
    def train(self):
        ...
        for epoch in range(self.config['num_epochs']):
            for i, real_images in enumerate(self.data_loader):
                # Train discriminator
         ...
         #   print(f'permuted fake_images.shape: {fake_images.shape}')
            ...
            save_image(fake_images.data[:16], f'{self.config["output_dir"]}/fake_images/fake_images_{epoch+1}.png', nrow=4, normalize=True)
